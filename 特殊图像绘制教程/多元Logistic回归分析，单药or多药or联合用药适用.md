...
### 补充说明
脚本默认将0-18岁人群作为基准来回归计算19-60，61+两类人群的相对风险但是受限于某些亚组0-18岁人群的样本量较小，导致其他组的P值较高。若需要改变年龄分组逻辑，参考下列代码改动逻辑：
```python
#原始代码：0-18、19-60、61+三个年龄段
        demo_df['age_group'] = pd.cut(demo_df['age_years'], 
                                bins=[0, 18, 60, np.inf], 
