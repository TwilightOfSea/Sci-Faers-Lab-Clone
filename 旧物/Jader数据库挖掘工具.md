...
- <img src="../pic/Jader插件运行结束界面.png" alt="Jader插件运行结束界面" width="450">
- 作为SciFaersLab的免费插件使用，现最新1.52版本请参考上边视频和邮箱的推送安装 
- 导出数据包括：目标药物的原始数据库、基线数据统计表、重要图像和不良反应信号值计算结果四个部分

<img src="../pic/Jader数据分析软件界面-readme.png" alt="Jader插件运行结束界面" width="350">
<img src="../pic/Jader数据分析软件界面.png" alt="Jader插件运行结束界面" width="350">
